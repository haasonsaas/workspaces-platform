...
- `BROKER_NETWORK_PROFILE_OVERRIDES` (default empty): JSON map of `policyProfile` -> override rules (public egress mode/allowlists, allowNon443 ports, internal suffixes).
